...
func init() {
	// during init the jfrog provider is registered
	globalregistry.RegisterProviderImplementation(
		"jfrog",
		newRegistry,
		jfrogRegistryCapabilities{},
	)
}
...
type jfrogRegistryCapabilities struct{}

func (cap jfrogRegistryCapabilities) CanPull() bool {
	return false
}

func (cap jfrogRegistryCapabilities) CanPush() bool {
	return false
}
